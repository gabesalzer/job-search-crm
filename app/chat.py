...
def build_corpus(applications: Optional[List[Dict[str, Any]]] = None,
    ...
    for app in applications:
        head = _kept([
            ...
            _line("Seniority", app.get("seniority")),
            _line("Speciality", app.get("speciality")),
            _line("Company funding stage", app.get("funding_stage")),
            _line("Company employees", app.get("employee_band")),
            ...
            _line("Their pain", _clip(app.get("pain"), MAX_NOTE_CHARS)),
            _line("Their process", _clip(app.get("process"), MAX_NOTE_CHARS)),
            _line("Risks", _clip(app.get("risks"), MAX_NOTE_CHARS)),
